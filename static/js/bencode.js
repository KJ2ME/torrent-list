/*
* Este código está hecno en base bencode_online de Chocobo1 (en gitub)
* cuando lo encontré usaba typescript, webpack y con la intención de
* simplificarlo, usé lo que había para hacer esta versión que consigue
* funcionar directamente en el navegador sin necesidad de npm, webpack,
* ni las dependencias de nodejs.
*
* En un principio iba a hacer esto desde 0, pero al final no vi complicado
* hacerlo a partir del código ya hecho de la librería bencode de nodejs
* y el código de Chocobo1, aunque no sabría decir si esto puede 
* considerarse un fork.
*
* Los códigos originales los pueden ver en github: 
* https://github.com/Chocobo1/bencode_online
* https://github.com/themasch/node-bencode
*
* PD: En todo caso, creo que la licencia de esté código sería MIT, así me evito
* líos innecesarios.
*/
